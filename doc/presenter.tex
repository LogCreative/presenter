...
\begin{documentation}
  ...
  presentation. The following command provides the interface for changing the
  theme or one of the components. You could visit the \texttt{testfiles/} folder
  for the code example of using these themes.
